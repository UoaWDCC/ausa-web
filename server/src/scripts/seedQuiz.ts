...
const sampleQuiz = {
  ...
  description: "Find personalized support resources based on how you're feeling",
  startQuestionId: "q1",
  questions: {
    q1: {
      id: "q1",
      ...
      options: [
        {
          ...
          resources: [
            {
              id: "res1",
              title: "UoA Student Support Services",
              description: "Connect with other students and join social groups",
              url: "https://www.auckland.ac.nz/en/students/student-support.html",
              type: "directory"
            },
            {
              id: "res2",
              ...
              url: "https://www.auckland.ac.nz/en/on-campus/student-support/personal-support/clubs-and-societies.html",
              type: "directory"
            },
            {
              id: "res3",
              ...
              url: "https://www.auckland.ac.nz/en/students.html",
              type: "directory"
            },
            {
              id: "res4",
              title: "International Student Support",
              description: "Specialized support for international students feeling isolated",
          ...
          resources: [
            {
              ...
              description: "Free confidential counselling to help you find direction",
              url: "https://www.auckland.ac.nz/en/students/student-support/personal-support/student-counselling.html",
              type: "directory"
            },
            {
              id: "res6",
              title: "Career Development Services",
              description: "Get help with finding your path and making decisions",
              url: "https://www.auckland.ac.nz/en/students/careers-and-employability.html",
              type: "directory"
            }
          ]
        },
          ...
          resources: [
            {
              ...
              description: "Free workshops and one-on-one support for academic skills",
              url: "https://www.auckland.ac.nz/en/students/academic-information/student-learning.html",
              type: "directory"
            },
            {
              id: "res8",
              title: "Academic Advisors",
              description: "Talk to your faculty's academic advisors about support options",
              url: "https://www.auckland.ac.nz/en/students/academic-information.html",
              type: "directory"
            }
          ]
        },
          ...
          resources: [
            {
              ...
              description: "If you're in immediate danger or having thoughts of suicide, call 111 now",
              url: "tel:111",
              type: "hotline"
            },
            {
              ...
              description: "Free call or text 1737 any time for support from a trained counsellor",
              url: "tel:1737",
              type: "hotline"
            },
            {
              id: "res11",
              title: "Lifeline",
              description: "Call 0800 543 354 or text HELP (4357) for 24/7 support",
              url: "tel:0800543354",
              type: "hotline"
            },
            {
          ...
          resources: [
            {
              ...
              url: "https://www.auckland.ac.nz/en/students/student-support/employment-opportunities.html",
              type: "directory"
            },
            {
              id: "res14",
            ...
            },
            {
              ...
              url: "https://www.auckland.ac.nz/en/students/student-support/scholarships-and-awards.html",
              type: "directory"
            }
          ]
        }
          ...
          resources: [
            {
              ...
              description: "Resources and information about mental health support",
          ...
          resources: [
            {
              ...
              url: "https://www.auckland.ac.nz/en/students/student-support/personal-support/campus-care.html",
              type: "directory"
            },
            {
              id: "res20",
              title: "Student Health Services",
              description: "Book an appointment with university doctors and nurses",
            ...
            },
            {
              ...
              description: "Free confidential counselling appointments",
              url: "https://www.auckland.ac.nz/en/students/student-support/personal-support/student-counselling.html",
              type: "directory"
            }
          ]
