...
export default async function SpiritualResourcesPage() {
  const data = await ResourceService.getSpiritualResources()

  return (
    <main className="min-h-screen flex flex-col items-center p-0">
      <header className="relative w-full h-[50vh]">
        <img
          src="/spiritual_resources.jpeg"
          className="absolute inset-0 w-full h-full object-cover brightness-60"
          alt="Spiritual Resources"
        />
